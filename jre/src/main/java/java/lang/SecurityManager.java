...
public class SecurityManager
{
	...
	public void checkPackageAccess(String pkg)
	{
		...
		synchronized (packageAccessLock)
		{
			...
			{
				String tmpPropertyStr = AccessController.doPrivileged((PrivilegedAction<java.lang.String>) () -> java.security.Security.getProperty("package.access"));
		 ...
		 */
		for (java.lang.String pkg2 : pkgs)
		{
			if (pkg.startsWith(pkg2) || pkg2.equals(pkg + "."))
			{
	...
	public void checkPackageDefinition(String pkg)
	{
		...
		synchronized (packageDefinitionLock)
		{
			...
			{
				String tmpPropertyStr = AccessController.doPrivileged((PrivilegedAction<java.lang.String>) () -> java.security.Security.getProperty("package.definition"));
