...
public abstract class ClassLoader
{
	...
	private final Vector<NativeLibrary> nativeLibraries = new Vector<>();
	...
	static void loadLibrary(Class<?> fromClass, String name, boolean isAbsolute)
	{
		...
		for (java.lang.String sys_path : sys_paths)
		{
		...
		if (loader != null)
		{
			for (java.lang.String usr_path : usr_paths)
			{
	...
	private static boolean loadLibrary0(Class<?> fromClass, final File file)
	{
		...
		if (!isBuiltin)
		{
			boolean exists = AccessController.doPrivileged((PrivilegedAction<java.lang.Object>) () -> file.exists() ? Boolean.TRUE : null) != null;
			if (!exists)
			{
				return false;
			}
