...
public final class AccessControlContext
{
	...
	private void checkPermission2(Permission perm)
	{
		...
		if (permissions != null)
		{
			...
			for (Permission limit : permissions)
			{
	 ...
	 */
	private void calculateFields(AccessControlContext assigned, @SuppressWarnings("hiding") AccessControlContext parent, @SuppressWarnings("hiding") Permission[] permissions)
	{
	...
	{
		if (!equalPDs(context, that.context))
		{
			return false;
		}
		if (combiner == null && that.combiner != null)
		{
			return false;
		}
		if (combiner != null && !combiner.equals(that.combiner))
		{
			return false;
		}
		return true;
	...
	private boolean equalLimitedContext(AccessControlContext that)
	{
		 ...
		 * isWrapped state.
		 */
		if (isWrapped && !that.isWrapped || !isWrapped && that.isWrapped)
		{
			return false;
		}
		if (permissions == null && that.permissions != null)
		{
			return false;
		}
		if (permissions != null && that.permissions == null)
		...
		if (!(containsAllLimits(that) && that.containsAllLimits(this)))
		{
			return false;
		}
		/*
		...
		if (parent != null && !parent.equals(that.parent))
		{
			return false;
		}
		return true;
	...
	private static boolean containsAllPDs(ProtectionDomain[] thisContext, ProtectionDomain[] thatContext)
	{
		...
		for (ProtectionDomain element : thisContext)
		{
			match = false;
			if ((thisPd = element) == null)
			{
	...
	public int hashCode()
	{
		...
		for (ProtectionDomain element : context)
		{
			if (element != null)
			{
